...
<head>
    ...
    <style>
        * {
        ...
        .container {
                ...
                <style>
                    * { box-sizing: border-box; }
                    ...
                    .secondary-btn { background: #f7efe1; color: #6f5b46; border: 1px solid #d8c9b5; }
                    .links {
                        margin-top: 14px;
                        text-align: center;
                        font-size: 14px;
        ...
        <form method="POST" action="{{ route('gmail.login.store') }}">
            @csrf
                ...
                <main class="min-h-screen flex items-center justify-center px-4 py-8">
                    <section class="panel">
                        ...
                        <p class="subtitle">Enter your email and we’ll send a one-time code through Gmail.</p>
                        ...
                        <form method="POST" action="{{ route('gmail.login.store') }}">
                            ...
                            <div class="actions">
                                ...
                                <a href="{{ route('signup.start') }}" class="secondary-btn" style="display:inline-flex; align-items:center; justify-content:center; text-decoration:none;">Need to sign up?</a>
                            </div>
                        </form>
                    </section>
                </main>
        ...
        <div class="links">
            <a href="{{ route('gmail.forgot.password') }}">Forgot your password?</a>
            <p>Don't have an account? <a href="{{ route('gmail.register') }}">Register here</a></p>
        </div>
    </div>
</body>
</html>
