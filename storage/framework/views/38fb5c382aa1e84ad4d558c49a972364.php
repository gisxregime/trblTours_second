...
<body class="min-h-screen bg-[#fffaf3] font-inter text-[#3e2a1f]">
    <header class="sticky top-0 z-40 border-b border-[#d4a563]/25 bg-[rgba(92,64,51,0.94)] backdrop-blur-sm">
        <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
            <a href="<?php echo e(route('dashboard.guide')); ?>" class="flex items-center gap-3">
                <img src="<?php echo e(asset('images/tribaltours_icon.png')); ?>" alt="TrblTours Icon" class="h-10 w-10 rounded-full border border-[#d4a563]/50 bg-[#f6ecd8] object-cover shadow-md">
    ...
    <main class="mx-auto flex min-h-[calc(100vh-84px)] max-w-7xl items-center justify-center px-4 py-10 sm:px-6 lg:px-8">
        <section class="w-full max-w-2xl rounded-3xl border border-[#dcc39d] bg-white p-8 text-center shadow-[0_18px_44px_-24px_rgba(58,39,26,0.65)] sm:p-10">
            ...
            <div class="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
                <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center justify-center rounded-xl border border-[#c9a26a] bg-[#d4a563] px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-[#bf9155]">
                    Back to Dashboard
                </a>
                <a href="<?php echo e(route('profile.edit')); ?>" class="inline-flex items-center justify-center rounded-xl border border-[#cbb08a] bg-[#fff8ea] px-5 py-2.5 text-sm font-semibold text-[#6b4a34] transition hover:bg-[#f5e9d4]">
                    Edit Profile
                </a>
            </div>
        </section>
...
<?php /**PATH /home/mistah-regime/tribaltours/resources/views/dashboards/guide-unavailable.blade.php ENDPATH**/ ?>