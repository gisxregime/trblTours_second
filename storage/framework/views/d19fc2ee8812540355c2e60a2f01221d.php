...
<head>
    ...
    <title><?php echo e(config('app.name', 'TrblTours')); ?> - Log In</title>
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <p class="text-sm text-rose-700"><?php echo e($message); ?></p>
                        <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('password.request')): ?>
                        <div class="password-meta">
                            <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-[#6f5b46] hover:underline">Forgot Password?</a>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
