                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <article class="overflow-hidden rounded-[18px] border border-[#e9d7b6] bg-white shadow-sm transition hover:shadow-md" role="presentation">
                                <div class="h-44 w-full bg-[#eef2df]">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($postImagePath !== ''): ?>
                                        <img src="<?php echo e($postImageSrc); ?>" alt="Guide story image" class="h-full w-full object-cover">
                                    <?php else: ?>
                                        <div class="flex h-full w-full items-center justify-center text-sm font-medium text-[#556b2f]">No image</div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                <div class="p-4">
                                    <p class="text-sm leading-6 text-slate-700"><?php echo e($post->caption ?: 'No caption provided.'); ?></p>
                                    <p class="mt-3 text-xs text-slate-500"><?php echo e($post->created_at?->diffForHumans()); ?></p>
                                </div>
                            </article>
